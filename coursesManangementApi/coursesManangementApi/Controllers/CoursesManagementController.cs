...
//        [HttpPost]
//        public async Task<ActionResult> AddCourse([FromBody] CreateCourseRequest course)
//        {
//            var result = await courseRepo.AddCourseAsync(course);
//            if (result)
//            {
...
//        }
//        [HttpPut("{id}")]
//        public async Task<ActionResult> UpdateCourse(int id, [FromBody] UpdateCourseRequest course)
//        {
//            var result = await courseRepo.UpdateCourseAsync(id, course);
//            if (result)
//            {
